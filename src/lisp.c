...
{int32 i;
 ...
 static char *BI[]=
    {"CAR","CDR","CONS","LAMBDA","SPECIAL","SETQ","ATOM","NUMBERP","QUOTE",
     ...
     "RPLACD","TSETQ", "NULL", "SET", "SETMOTOR"
    };
...
doit:    t= seval(U2);
	...
	/* Set the top-level value of U1 to seval(U2).*/
	 ...
	 f= seval(U1); goto assign;
      case 40: /*setmotor*/
	 motorSet(Ntab[ptrv(E1)].num,Ntab[ptrv(E2)].num);break;
